...
const Form = () => {
  ...
  return (
    <>
      ...
      {isSuccess && (
        <div className="p-4 w-max mb-4 text-sm text-green-800 rounded-lg bg-green-50 flex items-center gap-4 absolute right-6 bottom-0" data-aos="fade-down">
          <span className="font-medium">Form Submitted Successfully!!</span><span onClick={() => setIsSuccess(false)} className='material-icons cursor-pointer'>close</span>
        </div>
      )}
    </>
  )
